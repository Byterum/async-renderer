...
async function process(tokenAddress, tokenId, blockNum, stampDebug) {	
	var network = await provider.getNetwork();

	return await onNetworkLoaded(tokenAddress, tokenId, blockNum, stampDebug);
}

async function onNetworkLoaded(tokenAddress, tokenId, blockNum, stampDebug) {
	...
	console.log("Retrieved layout URI: " + tokenURI);
